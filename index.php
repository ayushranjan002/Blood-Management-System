    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill"style="background-image:url('images/blood-donation-wallpaper-thumb.jpg');" ></div>
      ...
      <div class="row">
        ...
        <div class="well">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="btn btn-primary btn-block" href="contact.php"><i class=""></i> Give Feedback</a>
                </div>
            </div>
        </div>
